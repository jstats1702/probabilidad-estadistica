...
2. Proponer un   **sistema de hipótesis estadísticas**.
...
**Hipótesis alternativa** ($H_1$): **hipótesis sobre la cual se quiere encontrar evidencia empírica**.
$$
...
![Errores tipo en el juzgamiento de hipótesis](errores tipo.jpg){width=90%}
